...
$(document).ready(function() {
    $(".menu-btn").on("click", function() {
        ...
        if (name === "HOME") {
            window.location.assign("../sampletext123!.html");
            // window.location.href = "sampletext123!.html";
...
}); // end inner $(document).ready for recipes

}); // end outer $(document).ready for menu/buttons